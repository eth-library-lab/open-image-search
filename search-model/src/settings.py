...
dataset_name = os.environ.get("DATASET_NAME","ethz")
...
metadata_csvs = os.environ.get("METADATA_CSVS", os.path.join(BASE_DIR, 'data','raw',dataset_name,'imageSearch_metadata_03.12.csv')) #piece_info.csv
if metadata_csvs:
...
features_fpath = os.path.join('data','processed', dataset_name, 'features','features.csv')
features_fpath =  os.environ.get('FEATURES_FPATH', features_fpath)
features_fpath = os.path.join(BASE_DIR,features_fpath)
